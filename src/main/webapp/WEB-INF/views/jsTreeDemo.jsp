...
<head>
    ...
    <script type="text/javascript" charset="utf8" src="<%=basePath%>DataTables-1.10.15/media/js/jstree.js"></script>
...
<body>
<div style=" height:auto;width: 1500px;; float:right; margin:20px;display:inline">
...
<div id="jstree2" class="demo" style="width:300px; height:auto; margin:20px; display:inline">></div>
<!-- Modal -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <%--<td><select class="form-control" onchange="onchange1(this)" style="width:250px" id="name">
                        <option>张三</option>
                        <option>李四</option>
                        <option>王五</option>
                        <option>陈六</option>
...
<script>
    ...
    $('#edit').click(function(){
        editFlag = true;
        var id = table.$('tr.selected').find("td:eq(1)").text();
        var name = table.$('tr.selected').find("td:eq(2)").text();
        var department = table.$('tr.selected').find("td:eq(3)").text();
        if(id == null || id == ''){
            alert("请选择要编辑的行");
            return false;
        }else{
    ...
    //点击事件
    $('#jstree2').bind("activate_node.jstree", function (obj, e) {
        // 处理代码
        // 获取当前节点
        var currentNode = e.node;
        department = currentNode.text;
        alert("点击事件id="+department);
        var oSettings = $('#table_id_example').dataTable().fnSettings();
        var url = "../tableDemoAjax?nodeId=" + currentNode.id;
